...
include "../db.php";
 ...
 $query = "SELECT * FROM libraian WHERE email = '$librarian_login'";
...
?>
       ...
       <link rel="stylesheet" href="../assets/vendor/data-table/media/css/dataTables.bootstrap.min.css">
        ...
        <li class="<?= $page == 'students.php' ? 'active-item':''?>"><a href="students.php"><i class="fa fa-group" aria-hidden="true"></i><span>Students</span></a></li>
        <!--UI ELEMENTENTS-->
        <li class="has-child-item open-item <?= $page == 'addbook.php'? 'open-item':''?><?= $page == 'managebook.php'? 'open-item':''?>">
        <a><i class="fa fa-book" aria-hidden="true"></i><span>Books</span></a>
        <ul class="nav child-nav level-1" style="">
            <li class="<?= $page == 'addbook.php' ? 'active-item':''?>"><a href="addbook.php">Add Book</a></li>
            <li class="<?= $page == 'managebook.php' ? 'active-item':''?>"><a href="managebook.php">Manage Book</a></li>
            
        </ul>
    </li>

     <li class="<?= $page == 'issueBook.php' ? 'active-item':''?>"><a href="issueBook.php"><i class="fa fa-group" aria-hidden="true"></i><span>Issue Book</span></a></li>

 <li class="<?= $page == 'returnBook.php' ? 'active-item':''?>"><a href="returnBook.php"><i class="fa fa-group" aria-hidden="true"></i><span>Return Book</span></a></li>
